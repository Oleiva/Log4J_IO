...
cd ..\..
mkdir output
java junit.textui.TestRunner CoreTestSuite
java junit.textui.TestRunner MinimumTestCase
java junit.textui.TestRunner LoggerTestCase
java junit.textui.TestRunner DOMTestCase
java junit.textui.TestRunner CustomLevelTestCase
java junit.textui.TestRunner XLoggerTestCase
del target\classes\log4j.xml
del target\classes\log4j.properties
java junit.textui.TestRunner TestCase1
copy input\xml\defaultInit.xml target\classes\log4j.xml
java junit.textui.TestRunner TestCase2
del target\classes\log4j.xml
copy input\xml\defaultInit.xml target\classes\log4j.xml
java -Dlog4j.defaultInitOverride=true junit.textui.TestRunner TestCase1
del target\classes\log4j.xml
copy input\defaultInit3.properties target\classes\log4j.properties
java junit.textui.TestRunner TestCase3
del target\classes\log4j.properties
copy input\xml\defaultInit.xml target\classes\log4j.xml
copy input\defaultInit3.properties target\classes\log4j.properties
java junit.textui.TestRunner TestCase4
del target\classes\log4j.xml
del target\classes\log4j.properties
java junit.textui.TestRunner XMLLayoutTestCase
java junit.textui.TestRunner AsyncAppenderTestCase
java junit.textui.TestRunner OptionConverterTestCase
java junit.textui.TestRunner BoundedFIFOTestCase
java junit.textui.TestRunner CyclicBufferTestCase
java junit.textui.TestRunner ORTestCase
java junit.textui.TestRunner LevelMatchFilterTestCase
java junit.textui.TestRunner PatternParserTestCase
java junit.textui.TestRunner PatternLayoutTestCase
java junit.textui.TestRunner DRFATestCase
